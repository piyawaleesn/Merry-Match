...
//     };
//     try {
//       await axios.post("/api/complaint", complaintData);
...
//       // }, 2000);
//     } catch (error) {
//       console.log("Error sending the complaint", error);
//     }
//   };
...
//             </button>
//           </div>
//           {/* {isComplaintSent && <p>Complaint successfully submitted!</p>} */}
//         </div>
//         <div className="w-[330px] h-[537px] ml-[8rem]">
//           <img src="https://hzhhjgfmkxwvwsdteigk.supabase.co/storage/v1/object/sign/user-storage/icons/img-login.svg?token=eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1cmwiOiJ1c2VyLXN0b3JhZ2UvaWNvbnMvaW1nLWxvZ2luLnN2ZyIsImlhdCI6MTY5Nzk3MzM0NSwiZXhwIjoxNzI5NTA5MzQ1fQ.dIUMbn462jvMG6pd4HXtXfW8LO_sjJGJXzzTVXNNiv4&t=2023-10-22T11%3A15%3A46.744Z" />
//         </div>
//       </div>
//       <Footer />
//     </>
